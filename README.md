...
Project Overview
This project analyzes employee and department data to generate meaningful HR and business insights using SQL Server. It focuses on salary distribution, hiring trends, workforce structure, and compensation analysis using advanced SQL techniques.
📁 Tables Used
departments
job_titles
employees
